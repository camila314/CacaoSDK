...
@interface cocos2d::CCBezierBy
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f6b40;
@end
...
@interface cocos2d::CCCallFunc
    ~CCCallFunc() = 0x454f50;
    ~CCCallFunc() = 0x454fb0;
    void update(float) = 0x455120;
    bool initWithTarget(cocos2d::CCObject*) = 0x454eb0;
    void execute() = 0x455130;
@end
...
@interface cocos2d::CCDirector
    ...
    ~CCDirector() = 0x2493b0;
    bool init() = 0x248df0;
    long getClassTypeInfo() = 0x24b280;
    cocos2d::CCScheduler* getScheduler() = 0x24af00;
    void setScheduler(cocos2d::CCScheduler*) = 0x24aec0;
    cocos2d::CCActionManager* getActionManager() = 0x24af50;
    ...
    cocos2d::CCKeypadDispatcher* getKeypadDispatcher() = 0x24b090;
    void setKeypadDispatcher(cocos2d::CCKeypadDispatcher*) = 0x24b050;
    cocos2d::CCKeyboardDispatcher* getKeyboardDispatcher() = 0x24aff0;
    void setKeyboardDispatcher(cocos2d::CCKeyboardDispatcher*) = 0x24afb0;
    cocos2d::CCMouseDispatcher* getMouseDispatcher() = 0x24b040;
    void setMouseDispatcher(cocos2d::CCMouseDispatcher*) = 0x24b000;
    cocos2d::CCAccelerometer* getAccelerometer() = 0x24b0e0;
    void setAccelerometer(cocos2d::CCAccelerometer*) = 0x24b0a0;
    float getDeltaTime() = 0x249bd0;
    cocos2d::CCSceneDelegate* getSceneDelegate() const = 0x24b320;
...
@interface cocos2d::CCMenuItem
    ...
    bool isEnabled() = 0x1fbaf0;
    void setEnabled(bool) = 0x1fbae0;
    bool isSelected() = 0x1fbb50;
@end
...
@interface cocos2d::CCNodeRGBA
    ...
    ~CCNodeRGBA() = 0x124bc0;
    bool init() = 0x124bf0;
    unsigned char getOpacity() = 0x124cd0;
    unsigned char getDisplayedOpacity() = 0x124cf0;
    ...
    cocos2d::_ccColor3B const& getColor() = 0x125020;
    cocos2d::_ccColor3B const& getDisplayedColor() = 0x125040;
    ...
    bool isOpacityModifyRGB() = 0x328f0;
@end
...
@interface cocos2d::CCRotateBy
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f5000;
@end
...
@interface cocos2d::CCRotateTo
    ...
    bool initWithDuration(float, float, float) = 0x1f4980;
@end
...
@interface cocos2d::CCTMXLayer
    ...
    cocos2d::CCTMXTilesetInfo* getTileSet() = 0x120d20;
    void setTileSet(cocos2d::CCTMXTilesetInfo*) = 0x120d30;
    cocos2d::CCDictionary* getProperties() = 0x1224a0;
...
@interface cocos2d::CCAtlasNode
    ...
    cocos2d::_ccColor3B const& getColor() = 0x1a5060;
    void setColor(cocos2d::_ccColor3B const&) = 0x1a50b0;
    void setOpacityModifyRGB(bool) = 0x1a5240;
    bool isOpacityModifyRGB() = 0x1a52f0;
    cocos2d::CCTextureAtlas* getTextureAtlas() = 0x1a54a0;
    void setTextureAtlas(cocos2d::CCTextureAtlas*) = 0x1a5460;
    cocos2d::_ccBlendFunc getBlendFunc() = 0x1a5320;
    void setBlendFunc(cocos2d::_ccBlendFunc) = 0x1a5340;
    unsigned int getQuadsToDraw() = 0x1a54b0;
    void setQuadsToDraw(unsigned int) = 0x1a54c0;
    void updateAtlasValues() = 0x1a4f60;
    cocos2d::CCTexture2D* getTexture() = 0x1a5430;
    void setTexture(cocos2d::CCTexture2D*) = 0x1a5360;
@end

@interface cocos2d::CCCallFuncN
    ~CCCallFuncN() = 0x455d90;
    ~CCCallFuncN() = 0x455df0;
    void execute() = 0x455190;
    long getClassTypeInfo() = 0x455e70;
    void initWithTarget(cocos2d::CCObject*, cocos2d::SEL_CallFuncN) = 0x455330;
@end

@interface cocos2d::CCCallFuncO
    ~CCCallFuncO() = 0x4558d0;
    ~CCCallFuncO() = 0x4558e0;
    void execute() = 0x455910;
    long getClassTypeInfo() = 0x4561d0;
    void initWithTarget(cocos2d::CCObject*, cocos2d::SEL_MenuHandler, cocos2d::CCObject*) = 0x455a20;
@end
...
@interface cocos2d::CCComponent
    ...
    void onExit() = 0x5a500;
    bool serialize(void*) = 0x5a520;
    bool isEnabled() const = 0x5a600;
...
@interface cocos2d::CCDelayTime
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f8b00;
@end
...
@interface cocos2d::CCEaseInOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a1fa0;
@end
...
@interface cocos2d::CCFileUtils
    ...
    unsigned char* getFileData(char const*, char const*, unsigned long*) = 0x23f140;
    unsigned char* getFileDataFromZip(char const*, char const*, unsigned long*) = 0x23f2e0;
    std::basic_string<char,std::char_traits<char>,std::allocator<char> > fullPathForFilename(char const*, bool) = 0x23f940;
    ...
    char const* fullPathFromRelativeFile(char const*, char const*) = 0x2408c0;
    void setSearchResolutionsOrder(std::vector<std::string> const&) = 0x240ac0;
    void addSearchResolutionsOrder(char const*) = 0x240d30;
    std::vector<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > const& getSearchResolutionsOrder() = 0x240df0;
    ...
    std::vector<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > const& getSearchPaths() = 0x240e00;
    std::basic_string<char,std::char_traits<char>,std::allocator<char> > getWritablePath2() = 0x241a90;
    bool isAbsolutePath(std::string const&) = 0x2419c0;
    void setPopupNotify(bool) = 0x2419d0;
    bool isPopupNotify() = 0x2419e0;
    bool init() = 0x23f010;
    std::basic_string<char,std::char_traits<char>,std::allocator<char> > getNewFilename(char const*) = 0x23f3f0;
    bool shouldUseHD() = 0x23f4e0;
    std::basic_string<char,std::char_traits<char>,std::allocator<char> > addSuffix(std::string, std::string) = 0x23f510;
    std::basic_string<char,std::char_traits<char>,std::allocator<char> > getPathForFilename(std::string const&, std::string const&, std::string const&) = 0x23f650;
    std::basic_string<char,std::char_traits<char>,std::allocator<char> > getFullPathForDirectoryAndFilename(std::string const&, std::string const&) = 0x241900;
    cocos2d::CCDictionary* createCCDictionaryWithContentsOfFile(std::string const&) = 0x23ec30;
    bool writeToFile(cocos2d::CCDictionary*, std::string const&) = 0x23ec40;
    cocos2d::CCArray* createCCArrayWithContentsOfFile(std::string const&) = 0x23ec50;
@end
...
@interface cocos2d::CCLayerRGBA
    ...
    bool init() = 0x273b40;
    unsigned char getOpacity() = 0x273be0;
    unsigned char getDisplayedOpacity() = 0x273c00;
    ...
    cocos2d::_ccColor3B const& getColor() = 0x273d60;
    cocos2d::_ccColor3B const& getDisplayedColor() = 0x273d80;
...
@interface cocos2d::CCLightning
    ~CCLightning() = 0x34cc70;
    ~CCLightning() = 0x34ccc0;
    void draw() = 0x34d200;
    void isOpacityModifyRGB() = 0x34d520;
    void setOpacityModifyRGB(bool) = 0x34d540;
    void getOpacity() = 0x34d450;
    void getDisplayedOpacity() = 0x34d470;
    void setOpacity(unsigned char) = 0x34d4a0;
    void updateDisplayedOpacity(unsigned char) = 0x34d560;
    void isCascadeOpacityEnabled() = 0x34d580;
    void setCascadeOpacityEnabled(bool) = 0x34d5a0;
    void getColor() = 0x34d4c0;
    void getDisplayedColor() = 0x34d5c0;
    void setColor(cocos2d::_ccColor3B const&) = 0x34d4e0;
    void updateDisplayedColor(cocos2d::_ccColor3B const&) = 0x34d5e0;
    void isCascadeColorEnabled() = 0x34d620;
    void setCascadeColorEnabled(bool) = 0x34d640;
@end
...
@interface cocos2d::CCSplitCols
    ...
    bool initWithDuration(float, unsigned int) = 0x45e5d0;
@end
...
@interface cocos2d::CCSplitRows
    ...
    bool initWithDuration(float, unsigned int) = 0x45e220;
@end

@interface cocos2d::CCTexture2D
    ~CCTexture2D() = 0x246350;
    ~CCTexture2D() = 0x2463b0;
    cocos2d::CCTexture2DPixelFormat getPixelFormat() = 0x246420;
    unsigned int getPixelsWide() = 0x246430;
    unsigned int getPixelsHigh() = 0x246440;
    unsigned int getName() = 0x246450;
    float getMaxS() = 0x2464e0;
    void setMaxS(float) = 0x2464f0;
    float getMaxT() = 0x246500;
    void setMaxT(float) = 0x246510;
    cocos2d::CCSize getContentSize() = 0x246460;
    cocos2d::CCGLProgram* getShaderProgram() = 0x246520;
    void setShaderProgram(cocos2d::CCGLProgram*) = 0x246530;
@end

@interface cocos2d::ExtraAction
    ~ExtraAction() = 0x1f9da0;
    ~ExtraAction() = 0x1f9db0;
    void update(float) = 0x1f2450;
    void step(float) = 0x1f2460;
    void reverse() = 0x1f23e0;
@end
...
@interface cocos2d::CCActionEase
    ...
    void stop() = 0x2a15b0;
    cocos2d::CCActionInterval* reverse() = 0x2a1600;
    cocos2d::CCActionInterval* getInnerAction() = 0x2a1620;
@end

@interface cocos2d::CCCallFuncND
    ~CCCallFuncND() = 0x455fb0;
    ~CCCallFuncND() = 0x456010;
    void execute() = 0x4556e0;
    long getClassTypeInfo() = 0x456090;
    void initWithTarget(cocos2d::CCObject*, cocos2d::SEL_CallFuncND, void*) = 0x455560;
@end
...
@interface cocos2d::CCEaseBackIn
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a42d0;
@end

@interface cocos2d::CCEaseBounce
    ~CCEaseBounce() = 0x2a5010;
    ~CCEaseBounce() = 0x2a5060;
    cocos2d::CCActionInterval* reverse() = 0x2a3890;
@end
...
@interface cocos2d::CCEaseSineIn
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a27c0;
@end
...
@interface cocos2d::CCGridAction
    ...
    cocos2d::CCActionInterval* reverse() = 0xee1a0;
    bool initWithDuration(float, cocos2d::CCSize const&) = 0xee0a0;
    cocos2d::CCGridBase* getGrid() = 0xee190;
@end
...
@interface cocos2d::CCLayerColor
    ...
    cocos2d::_ccBlendFunc getBlendFunc() = 0x274480;
...
@interface cocos2d::CCActionTween
    ...
    cocos2d::CCActionInterval* reverse() = 0x447760;
@end

@interface cocos2d::CCApplication
    ~CCApplication() = 0x1a3e10;
    void setAnimationInterval(double) = 0x1a3ee0;
    cocos2d::LanguageType getCurrentLanguage() = 0x1a3f40;
    cocos2d::TargetPlatform getTargetPlatform() = 0x1a3f20;
...
@interface cocos2d::CCEaseBackOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a44c0;
@end

@interface cocos2d::CCEaseElastic
    ~CCEaseElastic() = 0x2a4d50;
    ~CCEaseElastic() = 0x2a4da0;
    cocos2d::CCActionInterval* reverse() = 0x2a2dd0;
@end
...
@interface cocos2d::CCEaseSineOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a29a0;
@end

@interface cocos2d::CCIMEDelegate
    ~CCIMEDelegate() = 0x277670;
    bool attachWithIME() = 0x2776a0;
    bool detachWithIME() = 0x277880;
    bool canAttachWithIME() = 0x5ef30;
    void didAttachWithIME() = 0x5ef40;
    bool canDetachWithIME() = 0x5ef50;
    void didDetachWithIME() = 0x5ef60;
    void insertText(char const*, int) = 0x5ef70;
    void deleteBackward() = 0x5ef80;
    char const* getContentText() = 0x5ef90;
...
@interface cocos2d::CCParticleSun
    ~CCParticleSun() = 0x24d6e0;
    ~CCParticleSun() = 0x24d6f0;
    bool init() = 0x24d720;
    bool initWithTotalParticles(unsigned int) = 0x24bbb0;
@end
...
@interface cocos2d::CCReverseTime
    ...
    void stop() = 0x1f8f40;
    cocos2d::CCActionInterval* reverse() = 0x1f8fa0;
@end
...
@interface cocos2d::CCTMXTiledMap
    ...
    cocos2d::CCArray* getObjectGroups() = 0x2a63e0;
    void setObjectGroups(cocos2d::CCArray*) = 0x2a63f0;
    cocos2d::CCDictionary* getProperties() = 0x2a6430;
...
@interface cocos2d::CCEaseBounceIn
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a3b20;
@end
...
@interface cocos2d::CCParticleFire
    ~CCParticleFire() = 0x24d620;
    ~CCParticleFire() = 0x24d630;
    bool init() = 0x24d660;
    bool initWithTotalParticles(unsigned int) = 0x24b570;
@end

@interface cocos2d::CCParticleRain
    ~CCParticleRain() = 0x24d9e0;
    ~CCParticleRain() = 0x24d9f0;
    bool init() = 0x24da20;
    bool initWithTotalParticles(unsigned int) = 0x24d3f0;
@end

@interface cocos2d::CCParticleSnow
    ~CCParticleSnow() = 0x24d980;
    ~CCParticleSnow() = 0x24d990;
    bool init() = 0x24d9c0;
    bool initWithTotalParticles(unsigned int) = 0x24d0d0;
@end
...
@interface cocos2d::CCShakyTiles3D
    ...
    bool initWithDuration(float, cocos2d::CCSize const&, int, bool) = 0x45b7b0;
@end
...
@interface cocos2d::CCShuffleTiles
    ...
    bool initWithDuration(float, cocos2d::CCSize const&, unsigned int) = 0x45c140;
@end

@interface cocos2d::CCTMXLayerInfo
    ~CCTMXLayerInfo() = 0x2828c0;
    ~CCTMXLayerInfo() = 0x2828d0;
    cocos2d::CCDictionary* getProperties() = 0x282900;
...
@interface cocos2d::CCTextFieldTTF
    ...
    char const* getString() = 0x126d00;
    bool attachWithIME() = 0x126370;
    bool detachWithIME() = 0x1263f0;
    cocos2d::_ccColor3B const& getColorSpaceHolder() = 0x126a90;
    void setColorSpaceHolder(cocos2d::_ccColor3B const&) = 0x126aa0;
    void setPlaceHolder(char const*) = 0x126d20;
    char const* getPlaceHolder() = 0x126e10;
    void setSecureTextEntry(bool) = 0x126e20;
    bool isSecureTextEntry() = 0x126e70;
    bool canAttachWithIME() = 0x126470;
    bool canDetachWithIME() = 0x1264d0;
    void insertText(char const*, int) = 0x126530;
    void deleteBackward() = 0x126760;
    char const* getContentText() = 0x1269e0;
@end

@interface cocos2d::CCTextureAtlas
    ~CCTextureAtlas() = 0x26fe30;
    ~CCTextureAtlas() = 0x26fe40;
    unsigned int getTotalQuads() = 0x26fe70;
    unsigned int getCapacity() = 0x26fe80;
    cocos2d::CCTexture2D* getTexture() = 0x26fe90;
    void setTexture(cocos2d::CCTexture2D*) = 0x26fea0;
    cocos2d::_ccV3F_C4B_T2F_Quad* getQuads() = 0x26fee0;
...
@interface cocos2d::CCTileMapAtlas
    ...
    cocos2d::sImageTGA* getTGAInfo() = 0x106120;
...
@interface cocos2d::CCTouchHandler
    ...
    bool initWithDelegate(cocos2d::CCTouchDelegate*, int) = 0x247d10;
@end
...
@interface cocos2d::CCTurnOffTiles
    ...
    bool initWithDuration(float, cocos2d::CCSize const&, unsigned int) = 0x45d4d0;
@end
...
@interface cocos2d::CCWavesTiles3D
    ...
    bool initWithDuration(float, cocos2d::CCSize const&, unsigned int, float) = 0x45da40;
@end
...
@interface cocos2d::CCActionInstant
    ...
    bool isDone() = 0x4542c0;
    void step(float) = 0x4542d0;
    cocos2d::CCFiniteTimeAction* reverse() = 0x454300;
@end
...
@interface cocos2d::CCEaseBackInOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a4700;
@end
...
@interface cocos2d::CCEaseBounceOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a3d90;
@end
...
@interface cocos2d::CCEaseElasticIn
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a3050;
@end
...
@interface cocos2d::CCEaseSineInOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a2b90;
@end

@interface cocos2d::CCKeypadHandler
    ~CCKeypadHandler() = 0x1ff130;
    ~CCKeypadHandler() = 0x1ff1a0;
    bool initWithDelegate(cocos2d::CCKeypadDelegate*) = 0x1ff290;
@end
...
@interface cocos2d::CCLayerGradient
    ...
    bool initWithColor(cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&) = 0x2752b0;
    bool initWithColor(cocos2d::_ccColor4B const&, cocos2d::_ccColor4B const&, cocos2d::CCPoint const&) = 0x275310;
    cocos2d::_ccColor3B const& getStartColor() = 0x275610;
    void setStartColor(cocos2d::_ccColor3B const&) = 0x275620;
    cocos2d::_ccColor3B const& getEndColor() = 0x275670;
    void setEndColor(cocos2d::_ccColor3B const&) = 0x275640;
    unsigned char getStartOpacity() = 0x2756a0;
    void setStartOpacity(unsigned char) = 0x275680;
    unsigned char getEndOpacity() = 0x2756d0;
    void setEndOpacity(unsigned char) = 0x2756b0;
    cocos2d::CCPoint const& getVector() = 0x275710;
    void setVector(cocos2d::CCPoint const&) = 0x2756e0;
    void setCompressedInterpolation(bool) = 0x275730;
    bool isCompressedInterpolation() = 0x275720;
@end
...
@interface cocos2d::CCMenuItemLabel
    ...
    cocos2d::_ccColor3B const& getDisabledColor() = 0x1fbb80;
    void setDisabledColor(cocos2d::_ccColor3B const&) = 0x1fbb90;
    cocos2d::CCNode* getLabel() = 0x1fbbb0;
...
@interface cocos2d::CCParticleSmoke
    ~CCParticleSmoke() = 0x24d920;
    ~CCParticleSmoke() = 0x24d930;
    bool init() = 0x24d960;
    bool initWithTotalParticles(unsigned int) = 0x24cdd0;
@end
...
@interface cocos2d::CCPrettyPrinter
    ...
    void clear() = 0x2763a0;
    std::basic_string<char,std::char_traits<char>,std::allocator<char> > getResult() = 0x2763c0;
@end
...
@interface cocos2d::CCProgressTimer
    ...
    cocos2d::_ccColor3B const& getColor() const = 0x36c700;
    unsigned char getOpacity() const = 0x36c820;
    cocos2d::CCPoint getMidpoint() = 0x36e7c0;
...
@interface cocos2d::CCRenderTexture
    ...
    void draw() = 0x35d570;
    void visit() = 0x35d4e0;
    cocos2d::CCSprite* getSprite() = 0x35c620;
...
@interface cocos2d::CCFadeOutTRTiles
    ...
    float testFunc(cocos2d::CCSize const&, float) = 0x45cad0;
...
@interface cocos2d::CCFadeOutUpTiles
    ...
    float testFunc(cocos2d::CCSize const&, float) = 0x45d070;
...
@interface cocos2d::CCMenuItemSprite
    ...
    cocos2d::CCNode* getNormalImage() = 0x1fcee0;
    void setNormalImage(cocos2d::CCNode*) = 0x1fcef0;
    cocos2d::CCNode* getSelectedImage() = 0x1fcfc0;
    void setSelectedImage(cocos2d::CCNode*) = 0x1fcfd0;
    cocos2d::CCNode* getDisabledImage() = 0x1fd070;
...
@interface cocos2d::CCMenuItemToggle
    ...
    unsigned int getSelectedIndex() = 0x1fe8e0;
    void setSelectedIndex(unsigned int) = 0x1fe7e0;
    cocos2d::CCArray* getSubItems() = 0x1fde50;
    void setSubItems(cocos2d::CCArray*) = 0x1fde10;
@end

@interface cocos2d::CCParticleFlower
    ~CCParticleFlower() = 0x24d7a0;
    ~CCParticleFlower() = 0x24d7b0;
    bool init() = 0x24d7e0;
    bool initWithTotalParticles(unsigned int) = 0x24c1a0;
@end

@interface cocos2d::CCParticleGalaxy
    ~CCParticleGalaxy() = 0x24d740;
    ~CCParticleGalaxy() = 0x24d750;
    bool init() = 0x24d780;
    bool initWithTotalParticles(unsigned int) = 0x24be90;
@end

@interface cocos2d::CCParticleMeteor
    ~CCParticleMeteor() = 0x24d800;
    ~CCParticleMeteor() = 0x24d810;
    bool init() = 0x24d840;
    bool initWithTotalParticles(unsigned int) = 0x24c4c0;
@end

@interface cocos2d::CCParticleSpiral
    ~CCParticleSpiral() = 0x24d860;
    ~CCParticleSpiral() = 0x24d870;
    bool init() = 0x24d8a0;
    bool initWithTotalParticles(unsigned int) = 0x24c7e0;
@end
...
@interface cocos2d::CCTransitionFade
    ...
    void onExit() = 0x8ec60;
    bool initWithDuration(float, cocos2d::CCScene*) = 0x8eb10;
    bool initWithDuration(float, cocos2d::CCScene*, cocos2d::_ccColor3B const&) = 0x8ea50;
@end
...
@interface cocos2d::CCDeccelAmplitude
    ...
    cocos2d::CCActionInterval* reverse() = 0xeee10;
@end

@interface cocos2d::CCEGLViewProtocol
    ~CCEGLViewProtocol() = 0x29d7b0;
    cocos2d::CCSize const& getFrameSize() const = 0x29d950;
    void setFrameSize(float, float) = 0x29d960;
    cocos2d::CCSize getVisibleSize() const = 0x29d9a0;
    cocos2d::CCPoint getVisibleOrigin() const = 0x29d9f0;
    void setDesignResolutionSize(float, float, ResolutionPolicy) = 0x29d7c0;
    cocos2d::CCSize const& getDesignResolutionSize() const = 0x29d940;
    ...
    bool isScissorEnabled() = 0x29daf0;
    cocos2d::CCRect getScissorRect() = 0x29db10;
...
@interface cocos2d::CCEaseBounceInOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a40f0;
@end

@interface cocos2d::CCKeyboardHandler
    ~CCKeyboardHandler() = 0x241e90;
    ~CCKeyboardHandler() = 0x241f00;
    bool initWithDelegate(cocos2d::CCKeyboardDelegate*) = 0x241ff0;
@end
...
@interface cocos2d::CCTransitionScene
    ...
    void draw() = 0x89f40;
    bool initWithDuration(float, cocos2d::CCScene*) = 0x89ea0;
...
@interface cocos2d::CCCardinalSplineBy
    ...
    cocos2d::CCActionInterval* reverse() = 0x168160;
...
@interface cocos2d::CCCardinalSplineTo
    ...
    cocos2d::CCActionInterval* reverse() = 0x167f60;
...
@interface cocos2d::CCEaseElasticInOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a3620;
@end

@interface cocos2d::CCFadeOutDownTiles
    ~CCFadeOutDownTiles() = 0x45e9d0;
    ~CCFadeOutDownTiles() = 0x45e9e0;
    float testFunc(cocos2d::CCSize const&, float) = 0x45d280;
@end
...
@interface cocos2d::CCShatteredTiles3D
    ...
    bool initWithDuration(float, cocos2d::CCSize const&, int, bool) = 0x45bc70;
@end
...
@interface cocos2d::CCTransitionFadeBL
    ...
    cocos2d::CCActionInterval* actionWithSize(cocos2d::CCSize const&) = 0x90380;
@end
...
@interface cocos2d::CCTransitionFadeTR
    ...
    cocos2d::CCActionInterval* actionWithSize(cocos2d::CCSize const&) = 0x900c0;
    cocos2d::CCActionInterval* easeActionWithAction(cocos2d::CCActionInterval*) = 0x900e0;
@end

@interface cocos2d::CCTransitionFadeUp
    ~CCTransitionFadeUp() = 0x90460;
    ~CCTransitionFadeUp() = 0x904c0;
    cocos2d::CCActionInterval* actionWithSize(cocos2d::CCSize const&) = 0x90620;
@end
...
@interface cocos2d::CCEaseExponentialIn
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a21b0;
@end
...
@interface cocos2d::CCParticleBatchNode
    ...
    void draw() = 0x206da0;
    void visit() = 0x2062e0;
    cocos2d::CCTexture2D* getTexture() = 0x206f90;
    void setTexture(cocos2d::CCTexture2D*) = 0x206ee0;
    void setBlendFunc(cocos2d::_ccBlendFunc) = 0x206fc0;
    cocos2d::_ccBlendFunc getBlendFunc() = 0x206fe0;
@end

@interface cocos2d::CCParticleExplosion
    ~CCParticleExplosion() = 0x24d8c0;
    ~CCParticleExplosion() = 0x24d8d0;
    bool init() = 0x24d900;
    bool initWithTotalParticles(unsigned int) = 0x24cad0;
@end

@interface cocos2d::CCParticleFireworks
    ~CCParticleFireworks() = 0x24d680;
    ~CCParticleFireworks() = 0x24d690;
    bool init() = 0x24d6c0;
    bool initWithTotalParticles(unsigned int) = 0x24b910;
@end

@interface cocos2d::CCTiledGrid3DAction
    ~CCTiledGrid3DAction() = 0xef100;
    ~CCTiledGrid3DAction() = 0xef110;
    cocos2d::CCGridBase* getGrid() = 0xee350;
@end
...
@interface cocos2d::CCTransitionMoveInL
    ...
    cocos2d::CCActionInterval* action() = 0x8b180;
    cocos2d::CCActionInterval* easeActionWithAction(cocos2d::CCActionInterval*) = 0x8b1c0;
@end
...
@interface cocos2d::CCComponentContainer
    ...
    cocos2d::CCComponent* get(char const*) const = 0x1663a0;
    bool add(cocos2d::CCComponent*) = 0x166470;
    bool remove(char const*) = 0x1665f0;
    bool remove(cocos2d::CCComponent*) = 0x1668d0;
...
@interface cocos2d::CCEaseExponentialOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a23b0;
@end
...
@interface cocos2d::CCParticleSystemQuad
    ...
    bool initWithTotalParticles(unsigned int) = 0x36aa80;
...
@interface cocos2d::CCTransitionFadeDown
    ...
    cocos2d::CCActionInterval* actionWithSize(cocos2d::CCSize const&) = 0x908c0;
@end
...
@interface cocos2d::CCTransitionPageTurn
    ...
    bool initWithDuration(float, cocos2d::CCScene*, bool) = 0x20d190;
@end
...
@interface cocos2d::CCTransitionProgress
    ...
    cocos2d::CCProgressTimer* progressTimerNodeWithRenderTexture(cocos2d::CCRenderTexture*) = 0x137ba0;
...
@interface cocos2d::CCTransitionSlideInB
    ...
    cocos2d::CCActionInterval* action() = 0x8c970;
@end
...
@interface cocos2d::CCTransitionSlideInL
    ...
    cocos2d::CCActionInterval* action() = 0x8be00;
    cocos2d::CCActionInterval* easeActionWithAction(cocos2d::CCActionInterval*) = 0x8be60;
@end
...
@interface cocos2d::CCTransitionSlideInR
    ...
    cocos2d::CCActionInterval* action() = 0x8c290;
@end
...
@interface cocos2d::CCTransitionSlideInT
    ...
    cocos2d::CCActionInterval* action() = 0x8c600;
@end
...
@interface cocos2d::CCTransitionSplitCols
    ...
    cocos2d::CCActionInterval* action() = 0x8fa30;
    cocos2d::CCActionInterval* easeActionWithAction(cocos2d::CCActionInterval*) = 0x8fa50;
@end

@interface cocos2d::CCTransitionSplitRows
    ~CCTransitionSplitRows() = 0x8fb50;
    ~CCTransitionSplitRows() = 0x8fbb0;
    cocos2d::CCActionInterval* action() = 0x8fc20;
@end
...
@interface cocos2d::CCAccelDeccelAmplitude
    ...
    cocos2d::CCActionInterval* reverse() = 0xee750;
@end
...
@interface cocos2d::CCEaseExponentialInOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a25d0;
@end

@interface cocos2d::CCNotificationObserver
    ~CCNotificationObserver() = 0x132640;
    ~CCNotificationObserver() = 0x132680;
    cocos2d::CCObject* getTarget() = 0x1326e0;
    void getSelector() = 0x1326f0;
    char* getName() = 0x132700;
    cocos2d::CCObject* getObject() = 0x132710;
    int getHandler() = 0x132720;
...
@interface cocos2d::CCStandardTouchHandler
    ...
    bool initWithDelegate(cocos2d::CCTouchDelegate*, int) = 0x247ed0;
@end
...
@interface cocos2d::CCTransitionShrinkGrow
    ...
    cocos2d::CCActionInterval* easeActionWithAction(cocos2d::CCActionInterval*) = 0x8cde0;
@end
...
@interface cocos2d::CCTransitionTurnOffTiles
    ...
    cocos2d::CCActionInterval* easeActionWithAction(cocos2d::CCActionInterval*) = 0x8f6a0;
@end
...
@interface cocos2d::CCTransitionProgressInOut
    ...
    cocos2d::CCProgressTimer* progressTimerNodeWithRenderTexture(cocos2d::CCRenderTexture*) = 0x138300;
...
@interface cocos2d::CCTransitionProgressOutIn
    ...
    cocos2d::CCProgressTimer* progressTimerNodeWithRenderTexture(cocos2d::CCRenderTexture*) = 0x1384c0;
@end

@interface cocos2d::CCTransitionSceneOriented
    ~CCTransitionSceneOriented() = 0x8a330;
    ~CCTransitionSceneOriented() = 0x8a390;
    bool initWithDuration(float, cocos2d::CCScene*, cocos2d::tOrientation) = 0x8a4e0;
@end
...
@interface cocos2d::CCTransitionProgressRadialCW
    ...
    cocos2d::CCProgressTimer* progressTimerNodeWithRenderTexture(cocos2d::CCRenderTexture*) = 0x137dd0;
@end

@interface cocos2d::CCTransitionProgressVertical
    ~CCTransitionProgressVertical() = 0x1386e0;
    ~CCTransitionProgressVertical() = 0x1386f0;
    cocos2d::CCProgressTimer* progressTimerNodeWithRenderTexture(cocos2d::CCRenderTexture*) = 0x138110;
@end
...
@interface cocos2d::CCTransitionProgressRadialCCW
    ...
    cocos2d::CCProgressTimer* progressTimerNodeWithRenderTexture(cocos2d::CCRenderTexture*) = 0x137bb0;
@end
...
@interface cocos2d::CCTransitionProgressHorizontal
    ...
    cocos2d::CCProgressTimer* progressTimerNodeWithRenderTexture(cocos2d::CCRenderTexture*) = 0x137f50;
@end
...
@interface cocos2d::CCMenu
    ...
    bool ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = 0x438d20;
    ...
    bool isOpacityModifyRGB() = 0x18e6e0;
    bool isEnabled() = 0x18e6f0;
...
@interface cocos2d::CCNode
    ...
    cocos2d::CCPoint const& getPosition() = 0x122b60;
    void setPosition(float, float) = 0x122ba0;
    cocos2d::CCPoint const& getPosition(float*, float*) = 0x122b90;
    ...
    cocos2d::CCPoint const& getAnchorPoint() = 0x122d80;
    cocos2d::CCPoint const& getAnchorPointInPoints() = 0x122d70;
    void setContentSize(cocos2d::CCSize const&) = 0x122e50;
    cocos2d::CCSize const& getContentSize() const = 0x122e00;
    cocos2d::CCSize getScaledContentSize() = 0x122e10;
    ...
    unsigned int getOrderOfArrival() = 0x122f50;
    void setGLServerState(cocos2d::ccGLServerState) = 0x122fa0;
    cocos2d::ccGLServerState getGLServerState() = 0x122f90;
    ...
    cocos2d::CCArray* getChildren() = 0x122c80;
    unsigned int getChildrenCount() const = 0x122c90;
    void setParent(cocos2d::CCNode*) = 0x122ee0;
    cocos2d::CCNode* getParent() = 0x122ed0;
    ...
    cocos2d::CCActionManager* getActionManager() = 0x123e50;
    void setScheduler(cocos2d::CCScheduler*) = 0x123f20;
    cocos2d::CCScheduler* getScheduler() = 0x123f70;
    void updateTransform() = 0x1249d0;
    cocos2d::CCAffineTransform const nodeToParentTransform() = 0x124210;
    cocos2d::CCAffineTransform const parentToNodeTransform() = 0x1245d0;
    cocos2d::CCAffineTransform nodeToWorldTransform() = 0x124670;
    cocos2d::CCAffineTransform worldToNodeTransform() = 0x124710;
...
@interface cocos2d::CCBlink
    ...
    void stop() = 0x1f7880;
    cocos2d::CCActionInterval* reverse() = 0x1f7a70;
@end
...
@interface cocos2d::CCFlipX
    ...
    cocos2d::CCFiniteTimeAction* reverse() = 0x454930;
@end
...
@interface cocos2d::CCFlipY
    ...
    cocos2d::CCFiniteTimeAction* reverse() = 0x454ad0;
@end
...
@interface cocos2d::CCSpawn
    ...
    void stop() = 0x1f4690;
    cocos2d::CCActionInterval* reverse() = 0x1f4710;
@end

@interface cocos2d::CCSpeed
    ~CCSpeed() = 0x35b910;
    ~CCSpeed() = 0x35b970;
    bool isDone() = 0x35bc50;
    void startWithTarget(cocos2d::CCNode*) = 0x35bbe0;
    void stop() = 0x35bc00;
    void step(float) = 0x35bc30;
    cocos2d::CCActionInterval* reverse() = 0x35bc60;
@end
...
@interface cocos2d::CCEaseIn
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a1b40;
@end
...
@interface cocos2d::CCFadeIn
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f7ce0;
@end
...
@interface cocos2d::CCJumpBy
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f6290;
@end
...
@interface cocos2d::CCMoveBy
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f53b0;
@end
...
@interface cocos2d::CCRepeat
    ...
    bool isDone() = 0x1f37e0;
    void startWithTarget(cocos2d::CCNode*) = 0x1f3630;
    void stop() = 0x1f3680;
    cocos2d::CCActionInterval* reverse() = 0x1f37f0;
@end
...
@interface cocos2d::CCSkewBy
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f5d40;
    bool initWithDuration(float, float, float) = 0x1f5cb0;
@end
...
@interface cocos2d::CCSkewTo
    ...
    bool initWithDuration(float, float, float) = 0x1f58d0;
@end
...
@interface cocos2d::CCSprite
    ...
    bool initWithTexture(cocos2d::CCTexture2D*) = 0x133110;
    ...
    cocos2d::CCSpriteFrame* displayFrame() = 0x135760;
...
@interface cocos2d::CCString
    ~CCString() = 0x44c590;
    ~CCString() = 0x44c5a0;
    bool isEqual(cocos2d::CCObject const*) = 0x44c8f0;
...
@interface cocos2d::CCTintBy
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f8950;
@end
...
@interface cocos2d::CCAnimate
    ...
    void stop() = 0x1f95d0;
    cocos2d::CCActionInterval* reverse() = 0x1f9840;
@end

@interface cocos2d::CCEGLView
    ~CCEGLView() = 0x295420;
    void end() = 0x2954a0;
    bool isOpenGLReady() = 0x295470;
...
@interface cocos2d::CCEaseOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x2a1d50;
@end
...
@interface cocos2d::CCFadeOut
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f7f50;
@end
...
@interface cocos2d::CCFlipX3D
    ...
    bool initWithDuration(float) = 0x1273d0;
    bool initWithSize(cocos2d::CCSize const&, float) = 0x127420;
@end
...
@interface cocos2d::CCScaleBy
    ...
    cocos2d::CCActionInterval* reverse() = 0x1f76b0;
@end
...
@interface cocos2d::extension::CCTableView
    ...
    bool ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = 0x234bf0;
    ...
    void scrollViewDidScroll(cocos2d::extension::CCScrollView*) = 0x234830;
    void scrollViewDidZoom(cocos2d::extension::CCScrollView*) = 0x234ef0;
@end
...
@interface cocos2d::extension::CCScrollView
    ...
    cocos2d::CCSize const& getContentSize() const = 0x215e90;
    ...
    void visit() = 0x2164a0;
    bool ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = 0x216620;
    ...
    void setDirection(cocos2d::extension::CCScrollViewDirection) = 0x216f80;
@end
...
@interface cocos2d::extension::CCScale9Sprite
    ...
    bool isOpacityModifyRGB() = 0x213990;
    cocos2d::CCSize getPreferredSize() = 0x213620;
    void setPreferredSize(cocos2d::CCSize) = 0x2135f0;
    cocos2d::CCRect getCapInsets() = 0x2136e0;
    void setCapInsets(cocos2d::CCRect) = 0x213640;
    float getInsetLeft() = 0x213b30;
    void setInsetLeft(float) = 0x213b70;
    float getInsetTop() = 0x213b40;
    void setInsetTop(float) = 0x213b90;
    float getInsetRight() = 0x213b50;
    void setInsetRight(float) = 0x213bb0;
    float getInsetBottom() = 0x213b60;
    void setInsetBottom(float) = 0x213bd0;
    bool initWithBatchNode(cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, bool, cocos2d::CCRect) = 0x211690;
    bool initWithBatchNode(cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, cocos2d::CCRect) = 0x211630;
    bool initWithFile(char const*, cocos2d::CCRect, cocos2d::CCRect) = 0x212d50;
    bool initWithFile(char const*, cocos2d::CCRect) = 0x212e80;
    bool initWithFile(cocos2d::CCRect, char const*) = 0x212f80;
    bool initWithFile(char const*) = 0x213080;
    bool initWithSpriteFrame(cocos2d::CCSpriteFrame*, cocos2d::CCRect) = 0x213140;
    bool initWithSpriteFrame(cocos2d::CCSpriteFrame*) = 0x213250;
    bool initWithSpriteFrameName(char const*, cocos2d::CCRect) = 0x213310;
    bool initWithSpriteFrameName(char const*) = 0x213410;
    bool updateWithBatchNode(cocos2d::CCSpriteBatchNode*, cocos2d::CCRect, bool, cocos2d::CCRect) = 0x211730;
...
@interface cocos2d::extension::CCControlButton
    ...
    bool init() = 0x1a8420;
    bool ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = 0x1a9c20;
    ...
    unsigned char getOpacity() = 0x1aa090;
    void setOpacity(unsigned char) = 0x1a9fc0;
    cocos2d::_ccColor3B const& getColor() = 0x1aa180;
    ...
    cocos2d::CCSize getPreferredSize() = 0x1a8d20;
    void setPreferredSize(cocos2d::CCSize) = 0x1a8c60;
    bool getZoomOnTouchDown() = 0x1a8c50;
    void setZoomOnTouchDown(bool) = 0x1a8c40;
    cocos2d::CCPoint getLabelAnchorPoint() = 0x1a8d50;
    void setLabelAnchorPoint(cocos2d::CCPoint) = 0x1a8d70;
    void setMargins(int, int) = 0x1a8ae0;
    bool initWithLabelAndBackgroundSprite(cocos2d::CCNode*, cocos2d::extension::CCScale9Sprite*) = 0x1a8480;
    bool initWithTitleAndFontNameAndFontSize(std::string, char const*, float) = 0x1a88f0;
    bool initWithBackgroundSprite(cocos2d::extension::CCScale9Sprite*) = 0x1a8a30;
    cocos2d::CCString* getTitleForState(unsigned int) = 0x1a8db0;
    void setTitleForState(cocos2d::CCString*, unsigned int) = 0x1a8e90;
    cocos2d::_ccColor3B const getTitleColorForState(unsigned int) = 0x1a8f00;
    void setTitleColorForState(cocos2d::_ccColor3B, unsigned int) = 0x1a8f60;
    cocos2d::CCNode* getTitleLabelForState(unsigned int) = 0x1a9020;
    void setTitleLabelForState(cocos2d::CCNode*, unsigned int) = 0x1a9060;
    void setTitleTTFForState(char const*, unsigned int) = 0x1a9140;
    char const* getTitleTTFForState(unsigned int) = 0x1a9240;
    void setTitleTTFSizeForState(float, unsigned int) = 0x1a92b0;
    float getTitleTTFSizeForState(unsigned int) = 0x1a9330;
    void setTitleBMFontForState(char const*, unsigned int) = 0x1a93a0;
    char const* getTitleBMFontForState(unsigned int) = 0x1a9490;
    cocos2d::extension::CCScale9Sprite* getBackgroundSpriteForState(unsigned int) = 0x1a9500;
...
@interface cocos2d::extension::CCControlSlider
    ...
    bool ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = 0x1de890;
...
@interface cocos2d::extension::CCControlStepper
    ...
    bool ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = 0x1e1470;
...
@interface cocos2d::extension::CCControlHuePicker
    ...
    bool initWithTargetAndPos(cocos2d::CCNode*, cocos2d::CCPoint) = 0x1abb30;
@end
...
@interface cocos2d::extension::CCControlPotentiometer
    ...
    bool ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = 0x1ade70;
    ...
    bool isTouchInside(cocos2d::CCTouch*) = 0x1add50;
@end
...
@interface cocos2d::extension::CCControlSaturationBrightnessPicker
    ...
    bool ccTouchBegan(cocos2d::CCTouch*, cocos2d::CCEvent*) = 0x1b4030;
    ...
    bool initWithTargetAndPos(cocos2d::CCNode*, cocos2d::CCPoint) = 0x1b3820;
...
@interface cocos2d::extension::CCControl
    ...
    bool isOpacityModifyRGB() = 0x1a7d70;
    void setEnabled(bool) = 0x1a7e60;
    bool isEnabled() = 0x1a7e90;
    void setSelected(bool) = 0x1a7ea0;
    bool isSelected() = 0x1a7ec0;
    void setHighlighted(bool) = 0x1a7ed0;
    bool isHighlighted() = 0x1a7ef0;
    ...
    cocos2d::CCPoint getTouchLocation(cocos2d::CCTouch*) = 0x1a7d90;
    bool isTouchInside(cocos2d::CCTouch*) = 0x1a7de0;
@end
