class cocos2d::CCSprite {
    ...
    virtual bool isOpacityModifyRGB() = 0x135350;
    virtual bool initWithTexture(cocos2d::CCTexture2D*) = 0x133110;
    virtual bool initWithTexture(cocos2d::CCTexture2D*, cocos2d::CCRect const&) = 0x1330f0;
    virtual bool initWithTexture(cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool) = 0x132f10;
    virtual bool initWithSpriteFrame(cocos2d::CCSpriteFrame*) = 0x133270;
    virtual bool initWithSpriteFrameName(char const*) = 0x1332c0;
    virtual bool initWithFile(char const*) = 0x133180;
    virtual bool initWithFile(char const*, cocos2d::CCRect const&) = 0x133210;
    virtual void setTexture(cocos2d::CCTexture2D*) = 0x135a90;
    virtual cocos2d::CCTexture2D* getTexture() = 0x135c00;
    ...
    virtual cocos2d::CCSpriteBatchNode* getBatchNode() = 0x135910;
    ...
    virtual bool isFrameDisplayed(cocos2d::CCSpriteFrame*) = 0x1356d0;
    virtual cocos2d::CCSpriteFrame* displayFrame() = 0x135760;
    virtual void setDisplayFrameWithAnimationName(char const*, int) = 0x135680;
    // virtual bool isDirty() = 0x505b0;
