...
build_declare_virtual_win32 = """
	dupable getFunctionOf({cl}, {name}, {const}, {count}{trail}{types}) {{
		return lilac::meta::Function<std::remove_pointer<fun{id}>::type, lilac::meta::x86::Thiscall>{{ address{id} }}(this{trail}{params});
	}}
"""

build_declare_member_win32 = """
	dupable getFunctionOf({cl}, {name}, {const}, {count}{trail}{types}) {{
		return lilac::meta::Function<std::remove_pointer<fun{id}>::type, lilac::meta::x86::Membercall>{{ address{id} }}(this{trail}{params});
	}}
"""
